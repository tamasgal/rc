...
plugins=(poetry docker docker-compose docker-machine tmux vi-mode macos git git-extras git-flow svn history-substring-search colored-man-pages cp fasd extract pass)
