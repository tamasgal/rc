...
plugins=(docker tmux tmuxinator autojump vi-mode osx git git-extras git-flow git-remote-branch svn cabal history-substring-search colored-man-pages cp fasd extract)
