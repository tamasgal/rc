...
## Type: Dict
c.url.searchengines = {
    'DEFAULT': 'https://encrypted.google.com/search?hl=en&q={}',
    'af': 'https://duckduckgo.com/?q=site:bbs.archlinux.org+{}',
    ...
    'w': 'https://en.wikipedia.org/w/index.php?search={}&title=Special%3ASearch&go=Go',
    ...
    'np': 'http://docs.scipy.org/doc/numpy/search.html?q={}',
    'sp': 'http://docs.scipy.org/doc/scipy/reference/search.html?q={}',
    'pd': 'http://pandas.pydata.org/pandas-docs/stable/search.html?q={}',
    'sns': 'http://seaborn.pydata.org/search.html?q={}',
    'mpl': 'http://matplotlib.org/search.html?q={}&check_keywords=yes&area=default',
    'sl': 'https://encrypted.google.com/search?hl=en&q=site:scikit-learn.org%20{}',
    'sm': 'https://www.statsmodels.org/stable/search.html?q={}&check_keywords=yes&area=default',
    'tb': 'https://www.pytables.org/search.html?q={}&check_keywords=yes&area=default',
    'pyt': 'https://docs.pytest.org/en/latest/search.html?q={}check_keywords=yes&area=default',

    'kp': 'http://km3pipe.readthedocs.io/en/latest/search.html?q={}&check_keywords=yes&area=default',
    'ant': 'http://antares.in2p3.fr/internal/dokuwiki/doku.php?do=search&amp;id={}&amp;fulltext=Search',
    'km3': 'https://wiki.km3net.de/mediawiki/index.php?search={}&title=Special%3ASearch&go=Go',
    'iw': 'https://wiki.icecube.wisc.edu/index.php?title=Special%3ASearch&search={}&go=Go',
}
